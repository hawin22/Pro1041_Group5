...
public class ViewTrangChu_QuanLy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel25.add(cboMauSacTTSP);

        cboKichThuocTTSP.setToolTipText("");
        jPanel25.add(cboKichThuocTTSP);
        ...
        jPanel25.add(cboMauTTSP);

        jPanel25.add(cboChatLieuTTSP);
        jPanel25.add(txtHang);

        jLabel89.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel89.setText("Hãng:");
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addComponent(jTabbedPane4, javax.swing.GroupLayout.PREFERRED_SIZE, 1491, Short.MAX_VALUE)
        );
